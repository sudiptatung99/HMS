@section('title') {{ 'Complete Bill' }} @endsection 
<x-app-layout> 
        ...
        <div class="nk-block-between mb-3">    
            <div class="nk-block-head-content">
                ...
                <div class="nk-block-des text-soft">
                    <p>Complete Bill List</p>    
                </div>     
            </div> 
            <a href="{{ route('bill.create') }}" class="btn btn-white btn-outline-light">     
                        ...
                        <table class="datatable-init-export nowrap table"> 
                            ...
                            @foreach($bill as $key => $bill) 
                                <tr>
                                    <td>{{ $no++ }}</td>
                                    <td>{{ $bill->bill_no }}</td>
                                    <td><a href="{{ route('patient.show', encrypt($bill->patient_id)) }}">{{ $bill->patient->patient_id }}</a></td>   
                                    ...
                                    <td> 
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">  
                                                ...
                                                @can('bill-view')         
                                                    <li>
                                                        <a href="{{ route('bill.show', encrypt($bill->id)) }}"> 
                                                ...
                                                @can('update-bill')        
                                                    <li>
                                                        <a href="{{ route('bill.update', encrypt($bill->id)) }}"> 
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">     
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a class="btn btn-danger" href="{{ route('bill.delete', encrypt($bill->id)) }}">Yes</a>     
