@section('title') {{ 'Biohemistry Bill Create' }} @endsection
<x-app-layout>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body mt-3">
                        <form action="{{ route('biochemistry-bill.store') }}" method="POST">
                        @csrf
                            <div class="row">
                                <div class="col">
                                    <div class="row mb-4">
