@section('title') {{ 'Biochemistry Test Create' }} @endsection
<x-app-layout>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body mt-3">
                        <form action="{{ route('biochemistry-test.store') }}" method="POST">
                        @csrf
                            <div class="row">
                                <div class="col">
                                    <div class="row mb-4">
...
<script>
    for(let i = 1; i <= 500; i++) {
        $(document).on('change', '#parameter_id_'+ i +'', function (e) {
            ...
            $.ajax({
                url: "{{ route('get.biochemistry.parameter.details') }}",
                type: "POST",
                data: {
                    "_token": "{{ csrf_token() }}",
                ...
                success: function (data) {
                    document.getElementById('parameter_range_'+ i +'').value = data.biochemistry_parameter.range;
                    document.getElementById('parameter_unit_'+ i +'').value = data.biochemistry_parameter.unit;
                }
            })
        });
    }
