@section('title') {{ 'Biochemistry Test Update' }} @endsection
<x-app-layout>
    <div class="container-fluid">
        <div class="nk-block-between mb-3">
            ...
            <a href="{{ route('biochemistry-test') }}" class="btn btn-white btn-outline-light">
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body mt-3">
                        <form action="{{ route('biochemistry-test.update.store', encrypt($biochemistry_test->id)) }}" method="POST">
                        @csrf
                            <div class="row">
                                <div class="col">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="name" value="{{ $biochemistry_test->name }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="short_name" value="{{ $biochemistry_test->short_name }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-select js-select2" data-search="on" name="category_id" required>
                                                {{ getBiochemistryCategory($biochemistry_test->category_id) }}
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="method" value="{{ $biochemistry_test->method }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="amount" value="{{ $biochemistry_test->amount }}" id="amount" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" name="gst_percent" value="{{ $biochemistry_test->gst_percent }}" id="gst_percent" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="gst" value="{{ $biochemistry_test->gst }}" id="gst" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="total" value="{{ $biochemistry_test->total }}" id="total" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <tr @if($i != 1) id="row_{{ $i }}" @endif>
                                                <td>
                                                    <select class="form-select" name="parameter_id[]" id="parameter_id_{{ $i }}" required>
                                                        {{ getBiochemistryParameter($test_parameter->parameter_id) }}
                                                    </select>
                                                </td>
                                                <td>
...
<script>
    for(let i = 1; i <= 500; i++) {
        $(document).on('change', '#parameter_id_'+ i +'', function (e) {
            ...
            $.ajax({
                url: "{{ route('get.pathology.parameter.details') }}",
                type: "POST",
                data: {
                    "_token": "{{ csrf_token() }}",
                ...
                success: function (data) {
                    document.getElementById('parameter_range_'+ i +'').value = data.pathology_parameter.range;
                    document.getElementById('parameter_unit_'+ i +'').value = data.pathology_parameter.unit;
                }
            })
        });
    }
