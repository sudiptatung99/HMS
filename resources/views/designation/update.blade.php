@section('title') {{ 'Designation Update' }} @endsection
<x-app-layout>
    <div class="container-fluid">
        <div class="nk-block-between mb-3">  
            ...
            <a href="{{ route('designation') }}" class="btn btn-white btn-outline-light">   
            ...
            <div class="col-xl-12">
                <div class="card">  
                    <div class="card-body mt-3">  
                        <form action="{{ route('designation.update.store', encrypt($designation->id)) }}" method="POST">       
                        @csrf 
                            <div class="row mb-4">
