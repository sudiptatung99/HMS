...
<x-app-layout> 
    <div class="container-fluid">
        <div class="nk-block-between mb-3">    
            ...
            <a href="{{ route('doctor.create') }}" class="btn btn-white btn-outline-light">   
                        ...
                        <table class="datatable-init-export nowrap table"> 
                            ...
                            @foreach($doctor as $key => $doctor)   
                                <tr>
                                    ...
                                    <td>{{ env('COUNTRY_CODE') }} {{ $doctor->contact }}</td>     
                                    <td>
                                    ...
                                    <td> 
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">  
                                                ...
                                                @can('doctor-view')     
                                                    <li>
                                                        <a href="{{ route('doctor.show', encrypt($doctor->id)) }}"> 
                                                ...
                                                @can('delete-doctor')       
                                                    <li>
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#deleteWarning{{ $doctor->id }}">
                                ...
                                <div class="modal fade" id="deleteWarning{{ $doctor->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">   
                                    <div class="modal-dialog modal-dialog-centered">     
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a class="btn btn-danger" href="{{ route('doctor.delete', encrypt($doctor->id)) }}">Yes</a>     
