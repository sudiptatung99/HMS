...
<x-app-layout> 
    <div class="container-fluid">
        <div class="nk-block-between mb-3">    
            ...
            <a href="{{ route('expense.create') }}" class="btn btn-white btn-outline-light">   
                    ...
                    <div class="card-body"> 
                        <table class="datatable-init-export nowrap table"> 
                            ...
                            @foreach($expense as $key => $expense)   
                                <tr>
                                    <td>{{ $no++ }}</td>
                                    <td>{{ getDateFormat($expense->date) }}</td> 
                                    <td>{{ $expense->expense }}</td> 
                                    <td>{{ $expense->pay_to_whom }}</td> 
                                    <td>{{ env('CURRENCY_SYMBOL') . $expense->amount }}</td>  
                                    ...
                                    <td> 
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">  
                                                ...
                                                @can('update-expense')   
                                                    <li>
                                                        <a href="{{ route('expense.update', encrypt($expense->id)) }}">
                                                ...
                                                @can('delete-expense')       
                                                    <li>
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#deleteWarning{{ $expense->id }}">
                                ...
                                <div class="modal fade" id="deleteWarning{{ $expense->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">   
                                    <div class="modal-dialog modal-dialog-centered">     
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a class="btn btn-danger" href="{{ route('expense.delete', encrypt($expense->id)) }}">Yes</a>     
