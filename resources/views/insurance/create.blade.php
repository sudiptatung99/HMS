@section('title') {{ 'Insurance Create' }} @endsection
<x-app-layout>
            ...
            <div class="col-xl-12">
                <div class="card">  
                    <div class="card-body mt-3">  
                        <form action="{{ route('insurance.store') }}" method="POST" id="insurance_form">          
                        @csrf 
                            <div class="row mb-4"> 
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="policy_holder_name" required>
                                </div>
                            </div>    
                            <div class="row mb-4"> 
