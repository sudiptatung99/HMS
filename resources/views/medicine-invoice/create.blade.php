@section('title') {{ 'New Invoice Create' }} @endsection
<x-app-layout>
            ...
            <div class="col-xl-12">
                <div class="card">  
                    <div class="card-body mt-3">   
                        <form action="{{ route('medicine-invoice.store') }}" method="POST">        
                        @csrf                               
                            <div class="table-responsive">
                                <table class="table table-bordered" id="medicine_list">     
                                    ...
                                    <tbody>
                                        <tr id="row_1"> 
                                            <td>
                                                <select class="form-select" name="medicine_category_id" id="medicine_category_id_1" required>    
                                                    <option value="" selected disabled>--</option>  
                                                    {{ getMedicineCategory('') }}     
                                                </select>   
                                            </td> 
                                            <td>
                                                <select class="form-select" name="medicine_id[]" id="medicine_id_1" required>        
                                                    <option value="" selected disabled>--</option>   
                                                </select>     
                                            </td>    
                                            <td>
                                                <input type="date" class="form-control" name="expiry_date[]" id="expiry_date_1" readonly>  
                                            </td>
                                            <td>
                                                <div class="input-group">                                                    
                                                    <input type="number" class="form-control" min="1" name="quantity[]" id="quantity_1" required disabled>            
                                                    <input type="text" class="form-control" name="available_qty" id="available_qty_1" readonly>     
                                                </div>  
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="price[]" id="selling_price_1" readonly>      
                                            </td>  
                                            <td>
