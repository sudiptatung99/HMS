@section('title') {{ 'Medicine Vendor Create' }} @endsection
<x-app-layout>
            ...
            <div class="col-xl-12">
                <div class="card">  
                    <div class="card-body mt-3">  
                        <form action="{{ route('medicine-vendor.store') }}" method="POST">         
                        @csrf 
                            <div class="row mb-4">
                                <label class="col-sm-2 col-form-label">Vendor Name <i class="text-danger">*</i></label>
                                <div class="col-sm-8">
