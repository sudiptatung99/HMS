...
<x-app-layout> 
    <div class="container-fluid">
        <div class="nk-block-between mb-3">    
            ...
            <a href="{{ route('medicine.create') }}" class="btn btn-white btn-outline-light">   
                ...
                <div class="card"> 
                    <div class="card-body">
                        <table class="datatable-init-export nowrap table">  
                            ...
                            <tbody>
                            @php $no = 1; @endphp   
                            @foreach($medicine as $key => $medicine) 
                                <tr>
                                    <td>{{ $no++ }}</td>
                                    <td>{{ $medicine->name }}</td>
                                    ...
                                    <td>{{ getDateFormat($medicine->expiry_date) }}</td>    
                                    <td>
                                    ...
                                    <td> 
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">  
                                                ...
                                                @can('medicine-view')       
                                                    <li>
                                                        <a href="{{ route('medicine.show', encrypt($medicine->id)) }}"> 
                                                ...
                                                @can('update-medicine')      
                                                    <li>
                                                        <a href="{{ route('medicine.update', encrypt($medicine->id)) }}">
                                                ...
                                                @can('delete-medicine')   
                                                    <li>
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#deleteWarning{{ $medicine->id }}">
                                ...
                                <div class="modal fade" id="deleteWarning{{ $medicine->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">   
                                    <div class="modal-dialog modal-dialog-centered">     
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a class="btn btn-danger" href="{{ route('medicine.delete', encrypt($medicine->id)) }}">Yes</a>     
