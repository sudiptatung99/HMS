@section('title') {{ 'Microbiology Bill Update' }} @endsection
<x-app-layout>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body mt-3">
                        <form action="{{ route('microbiology-bill.update.store', encrypt($microbiology_bill->id)) }}" method="POST">
                        @csrf
                            <div class="row">
                                <div class="col">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-select js-select2" data-search="on" name="patient_id" id="patient_id" required>
                                                {{ getPatient($microbiology_bill->patient_id) }}
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" value="{{ $microbiology_bill->patient->name }}" id="patient_name" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <tr @if($i != 1) id="row_{{ $i }}" @endif>
                                                <td>
                                                    <select class="form-select" name="test_id[]" id="test_id_{{ $i }}" required>
                                                        {{ getMicrobiologyTest($pathology_test->test_id) }}
                                                    </select>
                                                </td>
                                                <td>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 mt-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control date-picker" name="bill_date" value="{{ $microbiology_bill->bill_date }}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 mt-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select js-select2" data-search="on" name="doctor_id" required>
                                                    {{ getDoctor($microbiology_bill->doctor_id) }}
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 mt-3">
                                            <div class="form-group">
                                                <label>Note</label>
                                                <textarea name="note" rows="3" class="form-control">{{ $microbiology_bill->note }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width="60%" colspan="2">
                                                    <input type="text" name="total" value="{{ $microbiology_bill->total }}" id="total" style="width: 50%; float: right;" class="form-control" readonly>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="60%" colspan="2">
                                                    <div class="input-group" style="width: 50%; float: right;">
                                                        <input type="number" min="1" name="discount_percent" value="{{ $microbiology_bill->discount_percent }}" id="discount_percent" class="form-control">
                                                        <input type="text" name="discount" value="{{ $microbiology_bill->discount }}" id="discount" class="form-control" readonly>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="60%" colspan="2">
                                                    <div class="input-group" style="width: 50%; float: right;">
                                                        <input type="text" name="gst" value="{{ $microbiology_bill->gst }}" id="gst" class="form-control" readonly>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="60%" colspan="2">
                                                    <input type="text" name="net_amount" value="{{ $microbiology_bill->net_amount }}" id="net_amount" style="width: 50%; float: right;" class="form-control" readonly>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select js-select2" data-search="on" name="payment_mode" required>
                                                    {{ getPaymentMethod($microbiology_bill->payment_mode) }}
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="payment_amount" value="{{ $microbiology_bill->payment_amount }}" id="payment_amount" class="form-control" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
