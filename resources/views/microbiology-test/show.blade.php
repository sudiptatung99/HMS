@section('title') {{ 'Microbiology Test View' }} @endsection
<x-app-layout>
    <div class="container-fluid">
        <div class="nk-block-between mb-3">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Microbiology Test</h3>
                <div class="nk-block-des text-soft">
                    <p>View Microbiology Test</p>
                </div>
            </div>
                                ...
                                <div class="card-inner">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-sm-6 col-md-4 col-xl-12">
                                            ...
                                            <span>{{ $microbiology_test->name }}</span>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-xl-12">
                                            <span class="sub-text">Short Name:</span>
                                            <span>{{ $microbiology_test->short_name }}</span>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-xl-12">
                                            <span class="sub-text">Category:</span>
                                            <span>{{ $microbiology_test->category->name }}</span>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-xl-12">
                                            <span class="sub-text">Method:</span>
                                            <span>{{ $microbiology_test->method }}</span>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-xl-12">
                                            <span class="sub-text">Amount:</span>
                                            <span>{{ env('CURRENCY_SYMBOL') . $microbiology_test->amount }}</span>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-xl-12">
                                            <span class="sub-text">GST:</span>
                                            <span>{{ $microbiology_test->gst_percent }}%</span>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-xl-12">
                                            <span class="sub-text">GST Amount:</span>
                                            <span>{{ env('CURRENCY_SYMBOL') . $microbiology_test->gst }}</span>
                                        </div>
                                        <div class="col-sm-6 col-md-4 col-xl-12">
                                            <span class="sub-text">Total:</span>
                                            <span>{{ env('CURRENCY_SYMBOL') . $microbiology_test->total }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
