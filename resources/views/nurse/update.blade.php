@section('title') {{ 'Nurse Update' }} @endsection 
<x-app-layout>  
    <div class="container-fluid">
        <div class="nk-block-between mb-3">  
            ...
            <a href="{{ route('nurse') }}" class="btn btn-white btn-outline-light">   
            ...
            <div class="col-xl-12">
                <div class="card">  
                    <div class="card-body mt-3">
                        <form action="{{ route('nurse.update.store', encrypt($nurse->id)) }}" method="POST" enctype="multipart/form-data">            
                        @csrf 
                            <div class="row mb-4">
                                <label class="col-sm-2 col-form-label">Name <i class="text-danger">*</i></label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="name" value="{{ $nurse->name }}" required>
                                </div>
                            </div> 
                            <div class="row mb-4">
                                <label class="col-sm-2 col-form-label">Email <i class="text-danger">*</i></label>
                                <div class="col-sm-8">
                                    <input type="email" class="form-control" name="email" value="{{ $nurse->email }}" required>
                                </div>
                            </div>      
                            <div class="row mb-4"> 
                                ...
                                <div class="col-sm-8">  
                                    <select class="form-select js-select2" data-search="on" name="department_id" required>   
                                        {{ getDepartment($nurse->department_id) }}      
                                    </select>      
                                </div>    
                            </div>   
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <img src="{{ asset($nurse->image) }}" width="100" height="70" class="img-thumbnail mt-2">  
                                </div> 
                            </div>      
                            <div class="row mb-4">
                                <label class="col-sm-2 col-form-label">Date of Birth <i class="text-danger">*</i></label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control date-picker" name="dob" value="{{ $nurse->dob }}" required>
                                </div> 
                            </div>    
                            <div class="row mb-4"> 
                            ...
                            <div class="row mb-4"> 
                                ...
                                <div class="col-sm-8">  
                                    <select class="form-select js-select2" data-search="on" name="blood_group" required>   
                                        {{ getBloodGroup($nurse->blood_group) }}     
                                    </select>       
                                </div> 
                            </div>   
                            <div class="row mb-4"> 
                                ...
                                <div class="col-sm-8"> 
                                    <select class="form-select js-select2" data-search="on" name="designation_id" required>   
                                        {{ getDesignation($nurse->designation_id) }}      
                                    </select>     
                                </div> 
                            </div>   
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control" name="address" required>{{ $nurse->address }}</textarea>   
                                </div> 
                            </div>  
                            <div class="row mb-4">
                                <label class="col-sm-2 col-form-label">Contact No. <i class="text-danger">*</i></label>
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" name="contact" value="{{ $nurse->contact }}" required>
                                </div>
                            </div>  
                            <div class="row mb-4">
                                <label class="col-sm-2 col-form-label">Emergency Contact No. <i class="text-danger">*</i></label>
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" name="emergency_contact" value="{{ $nurse->emergency_contact }}" required>
                                </div>
                            </div>    
                            <div class="row mb-4">
                                <label class="col-sm-2 col-form-label">Career Title <i class="text-danger">*</i></label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="career_title" value="{{ $nurse->career_title }}" required>  
                                </div>
                            </div> 
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <a href="{{ $nurse->resume }}" class="fw-bold" download style="float: right; margin-top: 5px;">Download Resume</a>   
                                </div> 
                            </div>    
                            <div class="row mb-4">
                                <label class="col-sm-2 col-form-label">Short Biogrphy <i class="text-danger">*</i></label>
                                <div class="col-sm-8">
                                    <textarea class="form-control" name="short_biogrphy" required>{{ $nurse->short_biogrphy }}</textarea>     
                                </div> 
                            </div>   
                            <div class="row mb-4">
                                <label class="col-sm-2 col-form-label">Specialist <i class="text-danger">*</i></label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="specialist" value="{{ $nurse->specialist }}" required> 
                                </div>
                            </div> 
                            <div class="row mb-4"> 
