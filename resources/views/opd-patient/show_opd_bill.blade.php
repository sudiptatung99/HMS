@section('title') {{ 'OPD Bill View' }} @endsection
<x-app-layout>
    <div class="container-fluid">
        <div class="nk-block-between mb-3">
            ...
            <a href="{{ route('opd-bill.index') }}" class="btn btn-white btn-outline-light">
                <em class="icon ni ni-list"></em><span>OPD List</span>
            </a>
        </div>
        <div class="row">
            <div class="col-xl-12">
                        ...
                        <div class="card invoice-wrap" id="section_to_print">
                            ...
                            <div class="invoice-head">
                                <div class="invoice-desc">
                                    <ul class="list-plain">
                                        <li><span>Patient ID</span>:<span>{{ $bill->opd_patient->patient_id }}</span></li>
                                        <li><span>Contact</span>:<span>{{ env('COUNTRY_CODE') }} {{ $bill->opd_patient->contact }}</span></li>
                                        <li><span>Admission</span>:<span>{{ getDateFormat($bill->opd_patient->admission_date) }}</span></li>
                                    </ul>
                                </div>
                                <div class="invoice-desc">
                                    <ul class="list-plain">
