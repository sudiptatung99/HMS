            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="mt-3 card-body">
                        <form action="{{ route('operation-bill.update.store', encrypt($operation_bill->id)) }}"
                            method="POST">
                            @csrf
                            <div class="row">
                                <div class="col">
                                    <div class="mb-4 row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-select js-select2" data-search="on" name="patient_id"
                                                ...
                                                {{ getPatient($operation_bill->patient_id) }}
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="mb-4 row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-select js-select2" data-search="on" name="operation_id"
                                                ...
                                                <option value="" selected disabled></option>
                                                {{getOperationName($operation_bill->patient_id,$operation_bill->patient_operations_id)}}
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                                ...
                                                <td width="60%" colspan="2">
                                                    <div class="input-group" style="width: 50%; float: right;">
                                                        <input type="number" min="1" name="discount_percent"
                                                            ...
                                                            value="{{ $operation_bill->discount_percent }}">
                                                        <input type="text" name="discount" id="discount"
                                                            class="form-control" readonly
                                                            value="{{ $operation_bill->discount }}">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="60%" colspan="2">
                                                    <div class="input-group" style="width: 50%; float: right;">
                                                        <input type="number" min="1" name="gst_percent"
                                                            ...
                                                            value="{{ $operation_bill->gst_percent }}">
                                                        <input type="text" name="gst" id="gst"
                                                            class="form-control" readonly
                                                            value="{{ $operation_bill->gst }}">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="60%" colspan="2">
                                                    <input type="text"
                                                        value="{{ $operation_bill->payment_amount }}" name="payable"
                                                        id="payable" style="width: 50%; float: right;"
                                                        class="form-control" readonly>
                                                </td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <div class="mt-3 row">
                                        <div class="mt-3 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select js-select2" data-search="on"
                                                    ...
                                                    <option value="" selected disabled></option>
                                                    {{ getPaymentMethod($operation_bill->payment_mode) }}
                                                </select>
                                            </div>
                                        </div>
                                        <div class="mt-3 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select js-select2" data-search="on"
                                                    ...
                                                    <option value="" selected disabled></option>
                                                    {{ getPaymentStatus($operation_bill->payment_status) }}
                                                </select>
                                            </div>
                                        </div>
                                        <div class="mt-2 col-md-12">
                                            <div class="form-group">
                                                <label>Note</label>
                                                <textarea name="note" rows="3" class="form-control">{{ $operation_bill->note }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    $.ajax({
        ...
        data: {
            "_token": "{{ csrf_token() }}",
            "id": "{{ $operation_bill->patient_operations_id }}"
        },
        success: function(data) {
            let patient = data.data;
            document.getElementById("operation_category").value = patient.category.name;
