@section('title') {{ 'Package Create' }} @endsection
<x-app-layout>
                                ...
                                <div class="col-sm-8">
                                    <table class="table table-bordered" id="service_list">     
                                        ...
                                        <tbody>
                                            <tr id="row_1"> 
                                                <td>
                                                    <select class="form-select" name="service_id[]" id="service_id_1" required>     
                                                        <option value="" selected disabled>--</option>   
                                                        {{ getService('') }}        
                                                    </select>   
                                                </td>   
                                                <td>
                                                    <input type="text" class="form-control" name="service_cost[]" id="rate_1" readonly>        
                                                </td>     
                                                <td>
