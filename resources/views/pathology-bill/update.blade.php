@section('title') {{ 'Pathology Bill Update' }} @endsection
<x-app-layout>
            ...
            <div class="col-xl-12">
                <div class="card">  
                    <div class="card-body mt-3"> 
                        <form action="{{ route('pathology-bill.update.store', encrypt($pathology_bill->id)) }}" method="POST">            
                        @csrf       
                            <div class="row">
                                <div class="col">
                                    <div class="row mb-4"> 
                                        ...
                                        <div class="col-sm-9"> 
                                            <select class="form-select js-select2" data-search="on" name="patient_id" id="patient_id" required>  
                                                {{ getPatient($pathology_bill->patient_id) }}      
                                            </select>   
                                        </div>
                                    </div>      
                                </div>
                                <div class="col">
                                    <div class="row mb-4"> 
                                        ...
                                        <div class="col-sm-9">  
                                            <input type="text" class="form-control" value="{{ $pathology_bill->patient->name }}" id="patient_name" readonly>  
                                        </div>     
                                    </div>          
                                </div>  
                            </div>       
                                    ...
                                    <div class="row"> 
                                        <div class="col-sm-12 mt-3">    
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control date-picker" name="bill_date" value="{{ $pathology_bill->bill_date }}" required>    
                                            </div>        
                                        </div>     
                                        <div class="col-sm-12 mt-3">    
                                            <div class="form-group">
                                                ...
                                                <select class="form-select js-select2" data-search="on" name="doctor_id" required>   
                                                    {{ getDoctor($pathology_bill->doctor_id) }}     
                                                </select>    
                                            </div>     
                                        </div>   
                                        <div class="col-sm-12 mt-3">  
                                            <div class="form-group">
                                                <label>Note</label>  
                                                <textarea name="note" rows="3" class="form-control">{{ $pathology_bill->note }}</textarea>   
                                            </div>  
                                        </div>   
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width="60%" colspan="2">  
                                                    <input type="text" name="total" value="{{ $pathology_bill->total }}" id="total" style="width: 50%; float: right;" class="form-control" readonly> 
                                                </td>
                                            </tr> 
                                            <tr> 
                                                ...
                                                <td width="60%" colspan="2">  
                                                    <div class="input-group" style="width: 50%; float: right;">     
                                                        <input type="number" min="1" name="discount_percent" value="{{ $pathology_bill->discount_percent }}" id="discount_percent" class="form-control">   
                                                        <input type="text" name="discount" value="{{ $pathology_bill->discount }}" id="discount" class="form-control" readonly>    
                                                    </div>    
                                                </td>   
                                            </tr>       
                                            <tr>
                                                ...
                                                <td width="60%" colspan="2">  
                                                    <div class="input-group" style="width: 50%; float: right;">           
                                                        <input type="text" name="gst" value="{{ $pathology_bill->gst }}" id="gst" class="form-control" readonly>     
                                                    </div>      
                                                </td> 
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="60%" colspan="2">  
                                                    <input type="text" name="net_amount" value="{{ $pathology_bill->net_amount }}" id="net_amount" style="width: 50%; float: right;" class="form-control" readonly>       
                                                </td>  
                                            </tr>
                                        </tbody>
                                    </table> 
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select js-select2" data-search="on" name="payment_mode" required>   
                                                    {{ getPaymentMethod($pathology_bill->payment_mode) }}      
                                                </select> 
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="payment_amount" value="{{ $pathology_bill->payment_amount }}" id="payment_amount" class="form-control" readonly>      
                                            </div> 
                                        </div>          
                                    </div> 
                                </div>  
...
<script>
    for(let i = 1; i <= 500; i++) {
        $(document).on('change', '#test_id_'+ i +'', function (e) {     
            ...
            $.ajax({
                url: "{{ route('get.pathology.test.details') }}",     
                type: "POST",   
                data: {
                    "_token": "{{ csrf_token() }}",
                    "test_id": test_id
