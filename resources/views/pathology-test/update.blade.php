@section('title') {{ 'Pathology Test Update' }} @endsection
<x-app-layout>
            ...
            <div class="col-xl-12">
                <div class="card"> 
                    <div class="card-body mt-3"> 
                        <form action="{{ route('pathology-test.update.store', encrypt($pathology_test->id)) }}" method="POST">           
                        @csrf     
                            <div class="row">
                                <div class="col">
                                    <div class="row mb-4"> 
                                        ...
                                        <div class="col-sm-9">  
                                            <input type="text" class="form-control" name="name" value="{{ $pathology_test->name }}" required>    
                                        </div>  
                                    </div>   
                                </div>
                                <div class="col">
                                    <div class="row mb-4"> 
                                        ...
                                        <div class="col-sm-9">  
                                            <input type="text" class="form-control" name="short_name" value="{{ $pathology_test->short_name }}" required>    
                                        </div>   
                                    </div>         
                                </div>  
                            </div>    
                            <div class="row">
                                    ...
                                    <div class="row mb-4"> 
                                        ...
                                        <div class="col-sm-9">   
                                            <select class="form-select js-select2" data-search="on" name="category_id" required>   
                                                {{ getPathologyCategory($pathology_test->category_id) }}       
                                            </select>        
                                        </div>    
                                    </div>     
                                </div>
                                <div class="col">
                                    <div class="row mb-4"> 
                                        ...
                                        <div class="col-sm-9">  
                                            <input type="text" class="form-control" name="method" value="{{ $pathology_test->method }}" required>    
                                        </div>   
                                    </div>         
                                </div>  
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="row mb-4"> 
                                        ...
                                        <div class="col-sm-9">  
                                            <input type="number" class="form-control" name="amount" value="{{ $pathology_test->amount }}" id="amount" required>     
                                        </div>    
                                    </div>          
                                </div> 
                                <div class="col">
                                    <div class="row mb-4"> 
                                        ...
                                        <div class="col-sm-9">   
                                            <input type="number" class="form-control" name="gst_percent" value="{{ $pathology_test->gst_percent }}" id="gst_percent" required>    
                                        </div>    
                                    </div>         
                                </div>  
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="row mb-4"> 
                                        ...
                                        <div class="col-sm-9">  
                                            <input type="text" class="form-control" name="gst" value="{{ $pathology_test->gst }}" id="gst" readonly>     
                                        </div>   
                                    </div>             
                                </div> 
                                <div class="col">
                                    <div class="row mb-4"> 
                                        ...
                                        <div class="col-sm-9">    
                                            <input type="text" class="form-control" name="total" value="{{ $pathology_test->total }}" id="total" readonly>    
                                        </div>    
                                    </div>             
                                </div>   
                            </div>    
                                            ...
                                            <tr @if($i != 1) id="row_{{ $i }}" @endif>   
                                                <td>
                                                    <select class="form-select" name="parameter_id[]" id="parameter_id_{{ $i }}" required>     
                                                        {{ getPathologyParameter($test_parameter->parameter_id) }}        
                                                    </select>     
                                                </td>    
                                                <td>  
