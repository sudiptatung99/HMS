...
<x-app-layout>
    <div class="container-fluid">
        <div class="nk-block-between mb-3">
            ...
            <a href="{{ route('operation.patient.create') }}" class="btn btn-white btn-outline-light">
                                        ...
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">
                                                ...
                                                @can('update-designation')
                                                    <li>
                                                        <a href="{{ route('operation.patient.update', encrypt($operation->id)) }}">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a class="btn btn-danger" href="{{ route('operation.patient.delete', encrypt($operation->id)) }}">Yes</a>
