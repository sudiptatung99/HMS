         ...
         <div class="nk-block-between mb-3">
            <div class="nk-block-head-content">
                ...
                <div class="nk-block-des text-soft">
                    <p>IPD - In Patient List</p>
                </div>
            </div>
            <a href="{{ route('patient.create') }}" class="btn btn-white btn-outline-light">
                                    ...
                                    <td>
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">
                                                ...
                                                @can('patient-view')
                                                    <li>
                                                        <a href="{{ route('patient.show', encrypt($patient->id)) }}">
                                                ...
                                                @can('update-patient')
                                                    <li>
                                                        <a href="{{ route('patient.update', encrypt($patient->id)) }}">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a class="btn btn-danger" href="{{ route('patient.delete', encrypt($patient->id)) }}">Yes</a>
