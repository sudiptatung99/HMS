@section('title') {{ 'Patient View' }} @endsection
<x-app-layout>
    <div class="container-fluid">
        <div class="nk-block-between g-3">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">IPD - In Patient / <strong class="text-primary small">{{ $patient->name }}</strong></h3>
                <div class="nk-block-des text-soft">
                    <ul class="list-inline">
                        <li>IPD - In Patient ID: <span class="text-base">{{ $patient->patient_id }}</span></li>
                    </ul>
                </div>
            </div>
