@section('title') {{ 'Radiology Bill Create' }} @endsection
<x-app-layout>
            ...
            <div class="col-xl-12">
                <div class="card">  
                    <div class="card-body mt-3"> 
                        <form action="{{ route('radiology-bill.store') }}" method="POST">           
                        @csrf     
                            <div class="row">
                                <div class="col">
                                    <div class="row mb-4"> 
                                    ...
                                    <div class="row"> 
                                        <div class="col-sm-12 mt-3">    
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control date-picker" name="bill_date" value="<?php echo date('Y-m-d'); ?>" required>    
                                            </div>        
                                        </div>        
                                        <div class="col-sm-12 mt-3">    
                                            <div class="form-group">
