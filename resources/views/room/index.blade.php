...
<x-app-layout> 
    <div class="container-fluid">
        <div class="nk-block-between mb-3">    
            ...
            <a href="{{ route('room.create') }}" class="btn btn-white btn-outline-light">   
                    ...
                    <div class="card-body">
                        <table class="datatable-init-export nowrap table"> 
                            ...
                            @foreach($room as $key => $room) 
                                    ...
                                    <td> 
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">  
                                                ...
                                                @can('update-room')      
                                                    <li>
                                                        <a href="{{ route('room.update', encrypt($room->id)) }}">
                                                ...
                                                @can('delete-room')     
                                                    <li>
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#deleteWarning{{ $room->id }}">
                                ...
                                <div class="modal fade" id="deleteWarning{{ $room->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">   
                                    <div class="modal-dialog modal-dialog-centered">     
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a class="btn btn-danger" href="{{ route('room.delete', encrypt($room->id)) }}">Yes</a>    
