@section('title') {{ 'Time Slot' }} @endsection 
<x-app-layout> 
    <div class="container-fluid">
        <div class="nk-block-between mb-3">    
            ...
            <a href="{{ route('slot.create') }}" class="btn btn-white btn-outline-light">   
                    ...
                    <div class="card-body">
                        <table class="datatable-init-export nowrap table">
                            ...
                            @foreach($slot as $key => $slot) 
                                <tr>
                                    ...
                                    <td>
                                        @if($slot->status == 'Active')
                                            <span class="badge badge-dot bg-success">{{ $slot->status }}</span>
                                        @elseif($slot->status == 'Inactive')  
                                            <span class="badge badge-dot bg-danger">{{ $slot->status }}</span>  
                                        @endif   
                                    </td>   
                                    <td> 
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">  
                                                ...
                                                @can('update-time-slot')  
                                                    <li>
                                                        <a href="{{ route('slot.update', encrypt($slot->id)) }}">
                                                ...
                                                @can('delete-time-slot')  
                                                    <li>
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#deleteWarning{{ $slot->id }}">
                                ...
                                <div class="modal fade" id="deleteWarning{{ $slot->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">   
                                    <div class="modal-dialog modal-dialog-centered">     
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a class="btn btn-danger" href="{{ route('slot.delete', encrypt($slot->id)) }}">Yes</a>    
