...
<x-app-layout>
    <div class="container-fluid">
        <div class="nk-block-between mb-3">
            ...
            <a href="{{ route('unit.create') }}" class="btn btn-white btn-outline-light">
                    ...
                    <div class="card-body">
                        <table class="datatable-init-export nowrap table">
                            ...
                            @foreach($unit as $key => $unit)
                                <tr>
                                    ...
                                    <td>
                                        @if($unit->status == 'Active')
                                            <span class="badge badge-dot bg-success">{{ $unit->status }}</span>
                                        @elseif($unit->status == 'Inactive')
                                            <span class="badge badge-dot bg-danger">{{ $unit->status }}</span>
                                        @endif
                                    </td>
                                    <td>
                                        <div class="drodown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">
                                                ...
                                                {{-- @can('update-designation') --}}
                                                    <li>
                                                        <a href="{{ route('unit.update', encrypt($unit->id)) }}">
                                                ...
                                                {{-- @can('delete-unit') --}}
                                                    <li>
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#deleteWarning{{ $unit->id }}">
                                ...
                                <div class="modal fade" id="deleteWarning{{ $unit->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a class="btn btn-danger" href="{{ route('unit.delete', encrypt($unit->id)) }}">Yes</a>
